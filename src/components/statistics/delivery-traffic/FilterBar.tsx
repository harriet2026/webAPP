...
export function FilterBar({
  ...
  // Sync draft when parent resets customRange (e.g. switching away then back to 'custom')
  useEffect(() => {
      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <SegmentedControl
            ...
            data-testid="delivery-direction"
          />
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <SegmentedControl
            ...
            size="sm"
            data-testid="delivery-time-range"
          />
        </div>
