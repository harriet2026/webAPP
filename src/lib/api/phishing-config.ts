...
export function putPhishingConfig(body: PhishAgentConfigPutRequest, requestFn: ApiRequestFn = apiRequest): Promise<ConfigMutationResult<PhishAgentConfig>> {
  return requestFn<ConfigMutationResult<PhishAgentConfig>>('/phishing-agent/config', { method: 'PUT', body });
}
